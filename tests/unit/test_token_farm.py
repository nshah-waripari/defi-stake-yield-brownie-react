...
def test_set_price_feed_contract():
    ...
    account = get_account()
    non_owner_account = get_account(index = 1) # get a random account
...
# amount_staked variable coomes from fixture defined in conftest.py
...
def test_issue_tokens(amount_staked):
    ...
    # Assert
    # We are staking 1 dapp token == in price equal to 1 ETH
    # so we should get 2,000 dapp tokens in reward
    # since the price of 1 ETH is equivalent to $2,000
    assert (
